...
function EditAction({
    ...
    const handleDelete = async () => {
        ...
        if (response.status == HttpStatusCode.Ok) {
            setAlert({ open: true, message: intl.formatMessage({ id: 'delete-combo-success' }), severity: 'success' });
            setReload(!reload);
        ...
        <Stack direction="row" sx={{ gap: 1, alignItems: 'center' }}>
            ...
            >
                <DialogTitle id="alert-dialog-title">
                    {intl.formatMessage({ id: 'delete-combo-confirm' })}
                </DialogTitle>

                <DialogContent>
                    <DialogContentText id="alert-dialog-description">
                        {intl.formatMessage({ id: 'delete-combo-description' })}
                    </DialogContentText>
                </DialogContent>
                ...
                >
                    <Stack direction="row" spacing={2} sx={{ flexGrow: 1, flexWrap: 'wrap' }}>
                        <OutlinedInput
                            ...
                            placeholder={intl.formatMessage({ id: 'search-combo-placeholder' })}
                            sx={{ minWidth: 100 }}
                            inputProps={{
                                sx: {
