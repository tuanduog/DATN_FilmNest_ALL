...
export default function AddConfirmForm({ handleBack, banner }: ConfirmProps) {
        ...
        try {
            ...
            if (response.status === HttpStatusCode.Ok) {
                navigate('/admin/banner', {
                    state: { alert: { open: true, severity: 'success', message: 'Thêm banner thành công' } }
                });
                ...
                <Box mb={4}>
                    ...
                    <Grid container spacing={2}>
                        ...
                        <Grid size={{ xs: 12, sm: 6 }}>
                            <Stack sx={{ gap: 1 }}>
                                <InputLabel sx={{ fontWeight: 'bold' }}>Tên banner</InputLabel>
